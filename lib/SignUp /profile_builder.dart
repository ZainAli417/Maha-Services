...
class _BP {
  ...
  static double hPad(double w) => isMobile(w) ? 16 : isTablet(w) ? 24 : 48;
  static double vPad(double w) => isMobile(w) ? 12 : isTablet(w) ? 20 : 28;
  static double cardPad(double w) => isMobile(w) ? 14 : isTablet(w) ? 18 : 24;
...
class _T {
  ...
  static TextStyle head({double fs = 16, Color? c}) =>
      GoogleFonts.plusJakartaSans(
          fontSize: fs, fontWeight: FontWeight.w800, color: c ?? textPri);

  static TextStyle body({double fs = 14, Color? c}) =>
      GoogleFonts.plusJakartaSans(fontSize: fs, color: c ?? textPri, height: 1.55);
}
...
InputDecoration _inputDec({
  ...
  String? label,
    ...
    InputDecoration(
      labelText: label,
      labelStyle:
      _T.label(fs: 12, fw: FontWeight.w600, c: _T.primary),
      hintText: hint,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Center(
                      child: ConstrainedBox(
                        constraints:
                        BoxConstraints(maxWidth: _BP.maxContent(w)),
        ...
        return _StepReview(
            ...
            onSubmit: () async {
              ...
              if (ok) {
                ...
                _snack(p.generalError ?? 'Error creating profile',
                    error: true);
              }
            });
      default:
...
class _Stepper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.symmetric(
          horizontal: _BP.hPad(w), vertical: isMob ? 10 : 14),
      decoration: const BoxDecoration(
          color: _T.white,
          ...
          return Column(mainAxisSize: MainAxisSize.min, children: [
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color:
                    isActive || isDone ? _T.primary : _T.border,
                    width: 1.5),
                boxShadow: isActive
                    ? [
                  BoxShadow(
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Container(
        ...
        child: Icon(Icons.account_circle_outlined,
            size: isMob ? 36 : 48, color: _T.primary),
      ),
            ...
            children: [
                  ...
                  children: [
                    for (final s in p.skills)
                      _SkillTag(
                          label: s,
                          onDelete: () =>
                              p.removeSkillAt(p.skills.indexOf(s))),
                  ],
                ),
                const SizedBox(height: 12),
              ],
              Row(children: [
                ...
                _SmallIconBtn(
                    ...
                    onTap: () {
                      final v =
                      p.skillInputController.text.trim();
                      if (v.isNotEmpty) {
                        p.addSkill(v);
                        p.skillInputController.clear();
                      }
                ...
                Wrap(
                  ...
                  children: [
                    for (final s in commonSkills
                        .where((s) =>
                    !p.skills.contains(s['label']))
                        .take(6))
                      _SuggestionChip(
                          label: s['label'] as String,
                          icon: s['icon'] as IconData,
                          onTap: () =>
                              p.addSkill(s['label'] as String)),
                  ],
                ),
              ],
            ],
        ...
        Column(children: [
          for (int i = 0; i < p.educationalProfile.length; i++)
            _EduItem(
              ...
              onEdit: () => _showEduModal(
                  context, p, i, p.educationalProfile[i]),
    ...
    showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx2, ss) => Dialog(
          ...
          child: ConstrainedBox(
            constraints:
            const BoxConstraints(maxWidth: 500, maxHeight: 640),
            child: Padding(
...
class _StepReview extends StatelessWidget {
      ...
      Container(
        ...
        child: isMob
          ...
          children: [
            Row(children: [
              _ProfileAvatar(
                  bytes: p.profilePicBytes, size: 56),
              const SizedBox(width: 12),
              Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Expanded(
                  ...
                  child: Column(children: [
                    ...
                    _ReviewCard(
                        ...
                        padding: cp,
                        child:
                        _EduReviewList(p.educationalProfile)),
                  ])),
              const SizedBox(width: 14),
              Expanded(
                  child: Column(children: [
  ...
  List<Widget> _reviewCards(
      BuildContext ctx, SignupProvider p, double cp) {
    final cards = <Widget>[];
    if (p.summaryController.text.isNotEmpty) {
    ...
    return Row(children: [
      Container(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(10)),
        child: Icon(icon,
            color: _T.primary, size: isMob ? 18 : 22),
      ),
      const SizedBox(width: 10),
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(title,
            style: _T.head(fs: isMob ? 17 : 22)),
        Text(subtitle,
            style: _T.label(fs: isMob ? 11 : 13)),
      ]),
    ]);
  }
}
  ...
  Widget build(BuildContext context) => Row(
    ...
    children: [
      TextButton.icon(
        ...
        label: Text('Back',
            style: _T.label(fs: 13, fw: FontWeight.w600)),
...
class _AvatarUploaderState extends State<_AvatarUploader> {
  ...
  Widget build(BuildContext context) {
    final has =
        widget.imageData != null || widget.networkImage != null;
    return MouseRegion(
      cursor: SystemMouseCursors.click,
      onEnter: (_) => setState(() => _hov = true),
      onExit: (_) => setState(() => _hov = false),
...
class _AutoField extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      Text(label,
          style: _T.label(
              fs: 12, c: _T.textPri, fw: FontWeight.w600)),
      const SizedBox(height: 5),
      Autocomplete<String>(
...
class _YearDrop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final years =
    List.generate(40, (i) => (2035 - i).toString());
    return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label,
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value:
                years.contains(value) ? value : years.first,
                isExpanded: true,
                icon: const Icon(
    ...
    child: GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            shape: BoxShape.circle),
        child: Icon(widget.icon,
            color: widget.color ?? _T.textSec, size: 17),
      ),
    ),
  );
}
...
class _SkillTag extends StatelessWidget {
  ...
  final bool compact;
  const _SkillTag(
      {required this.label, this.onDelete, this.compact = false});
  @override
  Widget build(BuildContext context) => Container(
    padding: EdgeInsets.symmetric(
