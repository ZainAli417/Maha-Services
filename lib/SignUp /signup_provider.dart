...
class SignupProvider extends ChangeNotifier {
  ...
  Future<String?> createJobSeekerAccount() async {
    ...
    final success = await _executeWithLoading(() async {
      ...
      // ✅ NEW: Check if ANY profile data exists (name, contact, etc.)
      ...
      // Determine isNew based on whether profile data was provided
      final isNewValue = 'yes';
      ...
      // ✅ NEW: Set target route based on isNew
      targetRoute = isNewValue == 'yes' ? '/profile-builder' : '/dashboard';
