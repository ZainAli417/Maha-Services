...
class _T {
  ...
  static TextStyle label({double fs = 11, Color? c, FontWeight fw = FontWeight.w500}) =>
      GoogleFonts.ibmPlexSans(fontSize: fs, fontWeight: fw, color: c ?? cSec);

  static TextStyle head({double fs = 14, Color? c}) =>
      GoogleFonts.ibmPlexSans(fontSize: fs, fontWeight: FontWeight.w700, color: c ?? c0);

  static TextStyle body({double fs = 13, Color? c}) =>
      GoogleFonts.ibmPlexSans(fontSize: fs, fontWeight: FontWeight.w400,
