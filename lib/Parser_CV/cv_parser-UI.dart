...
class _BP {
  ...
  static double hPad(double w)    => isMobile(w) ? 16 : isTablet(w) ? 24 : 40;
  static double vPad(double w)    => isMobile(w) ? 12 : isTablet(w) ? 20 : 28;
  static double cardPad(double w) => isMobile(w) ? 16 : isTablet(w) ? 22 : 28;
...
class BrandTypography {
  static TextStyle h1 = GoogleFonts.plusJakartaSans(
    ...
    letterSpacing: -1, color: BrandColors.slate950,
  );
  static TextStyle h2 = GoogleFonts.plusJakartaSans(
    fontSize: 24, fontWeight: FontWeight.w700,
    letterSpacing: -0.5, color: BrandColors.slate950,
  );
  static TextStyle body = GoogleFonts.plusJakartaSans(
    fontSize: 15, fontWeight: FontWeight.w400,
    color: BrandColors.slate800, height: 1.6,
  );
  static TextStyle label = GoogleFonts.plusJakartaSans(
    fontSize: 13, fontWeight: FontWeight.w600,
    color: BrandColors.slate600, letterSpacing: 0.5,
  );
  static TextStyle caption = GoogleFonts.plusJakartaSans(
    fontSize: 12, fontWeight: FontWeight.w500,
    color: BrandColors.slate400, letterSpacing: 0.3,
  );
}
...
class _CvUploadSectionState extends State<CvUploadSection>
  ...
  Widget _buildUploadView(double w) {
    ...
    return SingleChildScrollView(
      ...
      padding: EdgeInsets.symmetric(
          horizontal: _BP.hPad(w), vertical: _BP.vPad(w)),
      child: Center(
            ...
            children: [
              ...
              Text(
                ...
                style: BrandTypography.caption
                    .copyWith(color: BrandColors.slate400),
              ),
            ],
          ),
        ),
      ...
      child: Column(
        ...
        children: [
            ...
            Container(
              ...
              child: Stack(alignment: Alignment.center, children: const [
                ...
                Icon(Icons.description_outlined,
                    size: 36, color: BrandColors.indigo),
              ]),
            ),
          ]),
          ...
          Row(mainAxisSize: MainAxisSize.min, children: [
            Text('Extracting aviation data',
                style: BrandTypography.body.copyWith(
                    color: BrandColors.slate400, fontSize: 14)),
  ...
  Widget _buildStepContent(double w) {
    switch (_currentStep) {
      case 0: return _buildPersonalStep(w);
      case 1: return _buildEducationStep(w);
      case 2: return _buildExperienceStep(w);
      case 3: return _buildFinalReviewStep(w);
    ...
    return Column(
      ...
      children: [
        _buildSectionHeader('Personal Profile',
            'Personal record and contact details', w),
        ...
        SizedBox(height: gap),
        _buildTextField('Professional Summary', _controllers['bio'],
            false, isMob ? 3 : 4),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border:
            Border.all(color: BrandColors.slate200, width: 1.5),
          ),
          child: Wrap(
            spacing: isMob ? 8 : 10,
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    if (selected) ...[
                      ...
                      const Icon(Icons.check_circle,
                          size: 13, color: BrandColors.indigo),
                    ],
                  ]),
                ),
              );
    ...
    return Column(
      ...
      children: [
        _buildSectionHeader('Educational Background',
            'Academic qualifications and technical schooling', w),
        SizedBox(height: isMob ? 20 : 32),
        if (count == 0)
          _buildEmptyState('No academic data found.')
        else
          ...List.generate(count, (i) => _buildDataCard(
            ...
            children: [
              ...
              isMob
                  ? Column(children: [
                _buildTextField('Duration',   _controllers['edu_date_$i']),
                const SizedBox(height: 12),
                _buildTextField('GPA / Marks', _controllers['edu_grade_$i']),
              ])
                  : Row(children: [
  ...
  Widget _buildExperienceStep(double w) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('Operational Experience',
            'Detailed breakdown of flight commands and duties', w),
        SizedBox(height: isMob ? 20 : 32),
        if (count == 0)
          ...
          ...List.generate(count, (i) => _buildDataCard(
            ...
            children: [
              isMob
                  ? Column(children: [
                _buildTextField('Organization', _controllers['exp_org_$i']),
                const SizedBox(height: 12),
                ...
                const SizedBox(height: 12),
                _buildTextField('Aircraft Type', _controllers['exp_aircraft_$i']),
                const SizedBox(height: 12),
                _buildTextField('Flight Hours',  _controllers['exp_hours_$i']),
              ])
                  : Column(children: [
                Row(children: [
              ...
              SizedBox(height: isMob ? 12 : 18),
              _buildTextField('Duties & Responsibilities',
                  _controllers['exp_desc_$i'], false, isMob ? 3 : 4),
            ],
          )),
      ],
    );
        ...
        child: Column(children: [
          ...
          Text(
            ...
            style: BrandTypography.body
                .copyWith(color: BrandColors.slate400, fontSize: 13),
            textAlign: TextAlign.center,
          ),
        ]),
      ),
            ...
            children: _selectedSkills.map((skill) => Container(
              ...
              child: Text(skill,
                  style: BrandTypography.label.copyWith(
                      fontSize: 10, color: BrandColors.slate800)),
            )).toList(),
          ),
        ]),
      ]),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: BrandTypography.h1.copyWith(
                letterSpacing: 1.5, fontSize: isMob ? 20 : 30),
          ),
          const SizedBox(height: 10),
          Text(
          ...
          _buildReviewMainSection('PROFESSIONAL EXPERIENCE',
              Icons.work_outline),
          ..._buildExperienceReviewList(),
          SizedBox(height: isMob ? 24 : 36),
          _buildReviewMainSection('ACADEMIC BACKGROUND',
  ...
  Widget _buildReviewCircleAvatar() => Container(
    width: 72, height: 72,
    decoration: BoxDecoration(
        color: BrandColors.slate200, shape: BoxShape.circle,
        border: Border.all(color: Colors.white, width: 3)),
    child: const Icon(Icons.person,
        size: 36, color: BrandColors.slate400),
  );

  Widget _buildReviewSidebarSection(
      String title, List<Widget> children) =>
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(title,
            style: BrandTypography.label.copyWith(
                color: BrandColors.indigo, fontSize: 10)),
        const SizedBox(height: 12),
        ...children,
      ]);
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(
            child: Text(text,
                style: BrandTypography.body.copyWith(
                    fontSize: 12, color: BrandColors.slate800),
  ...
  List<Widget> _buildExperienceReviewList() {
    final count = _result?.professionalExperience.length ?? 0;
    if (count == 0) {
      return [Text('No experience entries.',
          style: BrandTypography.body)];
    }
    return List.generate(count, (i) => Padding(
      ...
      child: Column(
          ...
          children: [
            ...
            if (_controllers['exp_aircraft_$i']?.text.isNotEmpty ??
                false) ...[
              ...
              Text(
                  ...
                  style: BrandTypography.label.copyWith(
                      fontSize: 10, color: BrandColors.slate400)),
            ],
            const SizedBox(height: 6),
            Text(_controllers['exp_desc_$i']?.text ?? '',
                style: BrandTypography.body.copyWith(
                    fontSize: 13, color: BrandColors.slate800)),
          ]),
    ));
  }
  ...
  Widget _buildFooter(double w) {
    ...
    return Container(
      padding: EdgeInsets.symmetric(
          horizontal: isMob ? 0 : 20, vertical: isMob ? 16 : 20),
      decoration: const BoxDecoration(
        color: BrandColors.white,
        border: Border(
            top: BorderSide(color: BrandColors.slate200, width: 1)),
      ),
      child: Row(
            ...
            OutlinedButton(
              ...
              style: OutlinedButton.styleFrom(
                ...
                side: const BorderSide(
                    color: BrandColors.slate300, width: 1.5),
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
                ...
                borderSide: const BorderSide(
                    color: BrandColors.slate200, width: 1.5)),
            ...
            focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
                borderSide: const BorderSide(
                    color: BrandColors.indigo, width: 2)),
            errorBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
                borderSide: const BorderSide(
                    color: BrandColors.rose, width: 1.5)),
            focusedErrorBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
                borderSide: const BorderSide(
                    color: BrandColors.rose, width: 2)),
          ),
        ),
      ],
    );
        ...
        children: [
          Row(children: [
            const Icon(Icons.bookmark_border,
                size: 16, color: BrandColors.indigo),
            const SizedBox(width: 8),
            Text(title,
                style: BrandTypography.label.copyWith(
                    color: BrandColors.indigo, fontSize: 11)),
          ]),
          const SizedBox(height: 18),
          ...children,
        ],
  ...
  Future<void> _submitFinal() async {
    ...
    try {
      final success = await widget.provider
          .submitExtractedCvAndCreateAccount(_result!);
      if (success) {
    ...
    return LayoutBuilder(builder: (ctx, bc) {
      ...
      return Container(
        ...
        decoration: const BoxDecoration(
          color: BrandColors.white,
          border: Border(
              bottom: BorderSide(color: BrandColors.slate200)),
        ),
        child: isMob
  ...
  Widget _buildAiDisclaimer({bool isMob = false}) => Container(
    ...
    child: Row(mainAxisSize: MainAxisSize.min, children: [
      const Icon(Icons.auto_awesome,
          size: 11, color: BrandColors.emerald),
      const SizedBox(width: 5),
      Flexible(
        child: Text(
          isMob
