...
class JobDetailModal_recruiter extends StatefulWidget {
  ...
  @override
  State<JobDetailModal_recruiter> createState() =>
      _JobDetailModal_recruiterState();
}

class _JobDetailModal_recruiterState extends State<JobDetailModal_recruiter>
  ...
  Widget _buildApplicationSection() {
    ...
    final status = widget.jobData['status'] as String? ?? 'active';
          ...
          SizedBox(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: // inside your build method, where jobId and status are in scope:
                      ...
                      Switch.adaptive(
                        ...
                        onChanged: (newValue) async {
                          ...
                          if (error != null) {
                            ...
                            final msg = status == 'active' ? 'Job paused' : 'Job activated';
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text(msg), backgroundColor: Colors.green),
                            );
                            Navigator.of(context).pop(); // close dialog or refresh
                          }
                        },
                      ),
                    ],
