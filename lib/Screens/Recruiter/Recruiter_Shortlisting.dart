      ...
      child: isMobile
          ...
          : Row(
              children: [
                Expanded(
                  flex: 3,
                  child: _SearchField(ctrl: searchCtrl, height: h),
                ),
                const SizedBox(width: 10),
                ..._dropdowns(h),
              ],
...
class _FilterDropdown extends StatelessWidget {
      ...
      child: PopupMenuButton<String>(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(icon, size: 15, color: active ? _T.primary : _T.textSec),
  ...
  PopupMenuItem<String> _menuItem(String v, String t) => PopupMenuItem(
    value: v,
    child: Text(t, style: _T.body(fs: 13)),
  );
}
...
class _SortButton extends StatelessWidget {
  ...
  PopupMenuItem<String> _item(String v, String t) => PopupMenuItem(
    value: v,
    child: Text(t, style: _T.body(fs: 13)),
  );
}
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          transform: Matrix4.translationValues(
            0,
            _hovered && !widget.isSelected ? -3 : 0,
            0,
          ),
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          company,
                          style: _T.label(fs: 12, fw: FontWeight.w500),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ],
              ...
              if (skills.isNotEmpty) ...[
                ...
                Wrap(
                  spacing: 6,
                  runSpacing: 6,
                  children: [for (final s in skills.take(3)) _SkillPill(s)],
                ),
              ],
            ],
          ),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: ClipRRect(
      ...
      child: logoUrl != null && logoUrl!.isNotEmpty
          ...
          : const Icon(Icons.business_rounded, color: _T.textSec, size: 22),
    ),
  );
}
...
class _SkillPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Text(
      label,
      style: _T.label(fs: 11, c: _T.primary, fw: FontWeight.w600),
    ),
  );
}
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          'Tap any job card to view its applicants',
