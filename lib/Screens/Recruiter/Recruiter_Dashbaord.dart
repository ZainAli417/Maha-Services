...
class _Dashboard_RecruiterState extends State<Dashboard_Recruiter>
      ...
      builder: (context, constraints) {
        return Stack(
          children: [
            ...
            _buildFloatingAIChat(context, constraints),
            _buildAIAssistantFAB(),
          ],
        );
      },
    );
  ...
  Widget _buildFloatingAIChat(BuildContext context, BoxConstraints constraints) {
    if (!_showAIChat) return const SizedBox.shrink();
          ...
          Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                ...
                Tab(icon: Icon(Icons.smart_toy_outlined), text: 'Recruite.AI'),
              ],
            ),
          ),
          // Tab Views
