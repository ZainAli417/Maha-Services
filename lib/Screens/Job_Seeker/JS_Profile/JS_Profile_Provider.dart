...
// PROFESSIONAL EXPERIENCE temps + list
  ...
  List<Map<String, dynamic>> professionalExperience = []; // ✅ Already correct!
...
// CERTIFICATIONS / PUBLICATIONS / AWARDS / REFERENCES
  List<Map<String, String>> certifications = []; // ✅ CHANGED from List<String> to List<Map<String, String>>
  ...
  void _parseAndSetData(Map<String, dynamic> data) {
    ...
    // ✅ NEW: Parse structured certifications
...
// ✅ NEW: Parse certifications with backward compatibility
  List<Map<String, String>> _mapCertifications(dynamic v) {
    ...
    return v.map((item) {
      ...
      // Handle old structure: simple strings
...
// PATCH 1: ProfileProvider_NEW - Fix experience key values
// Replace the addExperienceEntry method:
...
// Certifications - ✅ UPDATED for new structure
  void addCertification(String name, {String organization = ''}) {
